...
public class GroupPerKeyTimestampedEvents {
    

    private static class MyStringFormatFn extends DoFn<KV<String, ? extends Number>, String> {
        @ProcessElement
        public void process(@Element KV<String, ? extends Number> element, @Timestamp Instant timestamp, BoundedWindow window, OutputReceiver<String> outputReceiver) {
    ...
    Create.TimestampedValues<KV<String, Integer>> timestampedEvents = Create.timestamped(
        // W1 [0-5) s
